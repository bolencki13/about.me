      ...
      <section id="bto-about-me" className="container">
        <div className="row h-100">
          <div className="col-12 text-center align-self-center">
            <img className="rounded" src="https://media.licdn.com/dms/image/C4E03AQFG0iHhtDVSvg/profile-displayphoto-shrink_200_200/0?e=1531353600&v=beta&t=6PWD8arccHJ1qvMoEWNHe1u6_RH21kN2wRTvd-D1Jmo" alt="photo of me"/>
